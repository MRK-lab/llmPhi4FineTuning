...
dataset = load_dataset("mrkswe/llmPhi4Try_CPU_6-2", split = "train")
...
if True: model.push_to_hub_gguf("mrkswe/endpointModelFT", tokenizer, quantization_method = "q4_k_m", token = "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")
